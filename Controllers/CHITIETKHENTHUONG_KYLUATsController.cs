...
{
    public class CHITIETKHENTHUONG_KYLUATsController : Controller
    {
        private LTQLDbContext db = new LTQLDbContext();

        // GET: CHITIETKHENTHUONG_KYLUATs
        public ActionResult Index()
        {
            return View(db.CHITIETKHENTHUONG_KYLUATs.ToList());
        }

        // GET: CHITIETKHENTHUONG_KYLUATs/Details/5
        ...
        // GET: CHITIETKHENTHUONG_KYLUATs/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: CHITIETKHENTHUONG_KYLUATs/Create
        ...
        // GET: CHITIETKHENTHUONG_KYLUATs/Edit/5
        ...
        // POST: CHITIETKHENTHUONG_KYLUATs/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: CHITIETKHENTHUONG_KYLUATs/Delete/5
        ...
        // POST: CHITIETKHENTHUONG_KYLUATs/Delete/5
